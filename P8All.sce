...
I2 = trapecioExt(sin2,inf,sup,0,1)

printf("Aproximacion trapecio compuesto bidimensional: %f\n", I)
printf("Aproximacion trapecio extendido bidimensional: %f\n", I2)*/
...
I1 = TrapecioBiYX(circulo,inf,sup,cosenoinf1,cosenosup1,n,m)
I2 = TrapecioBiXY(circulo,-1,1,cosenoinf2,cosenosup2,n,m)
I3 = SimpsonCompBiYX(circulo,inf,sup,cosenoinf1,cosenosup1,n,m)
I4 = SimpsonCompBiYX(circulo,-1,1,cosenoinf2,cosenosup2,n,m)
